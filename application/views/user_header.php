            ...
            <nav class="navbar-default navbar-static-side" role="navigation">
                <div class="sidebar-collapse">
                    <ul class="nav metismenu" id="side-menu">
                        ...
                        <li>
                            <a href="#"><i class="fa fa-question-circle"></i> <span class="nav-label">Absences</span><span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level collapse">
                                <li><a href="<?= base_url() ?>Absences/askAbsence">Demande d'absence</a></li>
                                <li><a href="#">Mes abscences</a></li>
                        ...
                        <li>
                            <a href="#"><i class="fa fa-edit"></i> <span class="nav-label">Sanctions</span></a>
                        ...
                        <li>
                            <a href="#"><i class="fa fa-desktop"></i> <span class="nav-label">Mes informations</span>  <span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level collapse">
